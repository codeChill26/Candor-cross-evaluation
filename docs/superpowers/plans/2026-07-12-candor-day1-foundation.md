...
-- ---------- rounds (Day 2 feature — table created now, locked down) ----------
...
-- No policies yet — deny-all for anon/authenticated until Day 2 defines
-- the real rules. service_role (admin client) always bypasses RLS.

-- ---------- round_questions (Day 2) ----------
...
-- ---------- submission_status (Day 2) — progress tracking only ----------
...
-- ---------- responses (Day 2/3) — NEVER add a reviewer-linking column ----------
